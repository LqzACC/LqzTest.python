...
#文件读取
filepath=r'C:\Users\11389\Desktop\画图\交流频率\14um\14um.csv'
file=open(filepath)
...
#原始计算数据写入
F,P,T=[],[],[]
u90,d90,u95,d95=[0.84,0.845,0.85,0.855,0.86],[0.87,0.875,0.88,0.885,0.89],[1.0,1.005,1.01,1.015,1.02],[1.03,1.035,1.04,1.045,1.05]#14
...
for i in range(0,len(F_90s)):
    app_f1.append(F_90s[i])#包括随机选取的补充点和随机选取的计算点
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\14um\90_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\14um\90_out.csv','a+',newline='')
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\14um\9095_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\14um\9095_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\14um\95_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\14um\95_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
plt.title('Cu 14um Thick I0-f Curve')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格
plt.scatter(app_ff1,app_pp1,c='g',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
plt.scatter(app_ff2,app_pp2,c='b',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
plt.scatter(app_ff3,app_pp3,c='r',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
...
ax.axhline(1.025, linestyle='-',c='r')
ax.axhline(0.865, linestyle='-',c='g')#水平虚线
ax.annotate('86.87K',xy=(205, 0.795), xycoords='data',fontsize=14)
ax.annotate('90.39K',xy=(205, 0.895), xycoords='data',fontsize=14)
ax.annotate('93.91K',xy=(205, 0.995), xycoords='data',fontsize=14)
ax.annotate('472.94K',xy=(205, 1.095), xycoords='data',fontsize=14)
ax.annotate('565.64K',xy=(205, 1.195), xycoords='data',fontsize=14)
ax.annotate('657.51K',xy=(205, 1.295), xycoords='data',fontsize=14)
ax.annotate('90K',xy=(80, 0.86), xycoords='data',fontsize=24,xytext=(60,0.92),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('95K',xy=(80, 1.025), xycoords='data',fontsize=24,xytext=(60,0.95),
            arrowprops=dict(facecolor='black', shrink=0.05))
plt.rcParams['xtick.direction'] = 'in'
plt.rcParams['ytick.direction'] = 'in'#坐标轴刻度向内
plt.savefig(r'C:\Users\11389\Desktop\画图\交流频率\14um\14um.png')
plt.show()
