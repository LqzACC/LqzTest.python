...
#文件读取
filepath=r'C:\Users\11389\Desktop\画图\交流频率\23um\23um.csv'
file=open(filepath)
...
F_90s,P_90s=[],[]
n=1
for i in random.sample(range(0,len(F_90),1),40):
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\23um\90_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\23um\90_out.csv','a+',newline='')
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\23um\9095_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\23um\9095_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\23um\95_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\23um\95_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
plt.title('Cu 23um Thick I0-f Curve')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格
plt.scatter(app_ff1,app_pp1,c='g',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
plt.scatter(app_ff2,app_pp2,c='b',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
plt.scatter(app_ff3,app_pp3,c='r',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
...
ax.axhline(1.265, linestyle='-',c='r')
ax.axhline(1.085, linestyle='-',c='g')#水平虚线
ax.annotate('83.30K',xy=(205, 0.795), xycoords='data',fontsize=14)
ax.annotate('84.96K',xy=(205, 0.895), xycoords='data',fontsize=14)
ax.annotate('87.27K',xy=(205, 0.995), xycoords='data',fontsize=14)
ax.annotate('90.27K',xy=(205, 1.095), xycoords='data',fontsize=14)
ax.annotate('92.00K',xy=(205, 1.195), xycoords='data',fontsize=14)
ax.annotate('325.55K',xy=(205, 1.295), xycoords='data',fontsize=14)
ax.annotate('90K',xy=(80, 1.08), xycoords='data',fontsize=24,xytext=(60,1.15),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('95K',xy=(80, 1.265), xycoords='data',fontsize=24,xytext=(60,1.19),
            arrowprops=dict(facecolor='black', shrink=0.05))
plt.rcParams['xtick.direction'] = 'in'
plt.rcParams['ytick.direction'] = 'in'#坐标轴刻度向内
plt.savefig(r'C:\Users\11389\Desktop\画图\交流频率\23um\23um.png')
plt.show()
