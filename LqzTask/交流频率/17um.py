...
#文件读取
filepath=r'C:\Users\11389\Desktop\画图\交流频率\17um\17um.csv'
file=open(filepath)
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\17um\90_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\17um\90_out.csv','a+',newline='')
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\17um\9095_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\17um\9095_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
outputpath=r'C:\Users\11389\Desktop\画图\交流频率\17um\95_out.csv'
outputfile=open(r'C:\Users\11389\Desktop\画图\交流频率\17um\95_out.csv','a+',newline='')
Writer = csv.writer(outputfile)
...
ax.annotate('85.24K',xy=(205, 0.795), xycoords='data',fontsize=14)
ax.annotate('87.81K',xy=(205, 0.895), xycoords='data',fontsize=14)
ax.annotate('90.98K',xy=(205, 0.995), xycoords='data',fontsize=14)
ax.annotate('94.19K',xy=(205, 1.095), xycoords='data',fontsize=14)
ax.annotate('450.18K',xy=(205, 1.195), xycoords='data',fontsize=14)
ax.annotate('527.36K',xy=(205, 1.295), xycoords='data',fontsize=14)
ax.annotate('90K',xy=(80, 0.94), xycoords='data',fontsize=24,xytext=(60,1),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('95K',xy=(80, 1.11), xycoords='data',fontsize=24,xytext=(60,1.03),
            arrowprops=dict(facecolor='black', shrink=0.05))
plt.rcParams['xtick.direction'] = 'in'
plt.rcParams['ytick.direction'] = 'in'#坐标轴刻度向内
plt.savefig(r'C:\Users\11389\Desktop\画图\交流频率\17um\17um.png')
plt.show()
