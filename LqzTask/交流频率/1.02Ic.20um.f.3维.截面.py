...
#写入输出地址
w=r'C:\Users\11389\Desktop\画图\交流频率\20um\1.02.csv'
o1=r'C:\Users\11389\Desktop\画图\交流频率\20um\1.02.png'
...
for i in y:#频率
    z = Tc[n].tolist()#温度
    verts.append([(x[0], 87), *zip(x, z), (x[-1], 87)])
    n=n+1

poly = PolyCollection(verts, facecolors=['darkgreen', 
                                         'plum', 'darkviolet', 'mediumpurple', 'indigo',
                                         'pink','lightcoral'], alpha=0.7)
...
ax.set_title('0.5s 20um Thick 1.02Ic Vary Frequency')
plt.savefig(o1)
plt.show()
