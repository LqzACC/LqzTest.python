...
o1=r'C:\Users\11389\Desktop\画图\磁场角度\W.7t.0-90d.vf.png'
...
plt.title('0.2s Cu 30um Thick Superconductor layer')#标题
...
plt.plot(Theta.tolist(),F180.tolist(), 'v',c='r',markerfacecolor='white',markeredgecolor='r');
#ax.fill_between(Theta.tolist(), F180.tolist(), 0, facecolor='r', alpha=0.7)

plt.plot(Theta.tolist(),F190.tolist(),c='g',linestyle='-',linewidth=2,label='190Hz')
plt.plot(Theta.tolist(),F190.tolist(), '^',c='g',markerfacecolor='white',markeredgecolor='g');
#ax.fill_between(Theta.tolist(), F190.tolist(), 0, facecolor='g', alpha=0.6)
...
#ax.fill_between(Theta.tolist(), F200.tolist(), 0, facecolor='g', alpha=0.5)

plt.plot(Theta.tolist(),F210.tolist(),c='gray',linestyle='-',linewidth=2,label='210Hz')
plt.plot(Theta.tolist(),F210.tolist(), 's',c='gray',markerfacecolor='white',markeredgecolor='gray');
#ax.fill_between(Theta.tolist(), F210.tolist(), 0, facecolor='g', alpha=0.4)

plt.plot(Theta.tolist(),F220.tolist(),c='plum',linestyle='-',linewidth=2,label='220Hz')
plt.plot(Theta.tolist(),F220.tolist(), 'o',c='plum',markerfacecolor='white',markeredgecolor='plum');
#ax.fill_between(Theta.tolist(), F220.tolist(), 0, facecolor='g', alpha=0.3)
