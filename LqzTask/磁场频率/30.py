...
#写入输出地址
w=r'C:\Users\11389\Desktop\画图\磁场频率\30um\30um.csv'
o1=r'C:\Users\11389\Desktop\画图\磁场频率\30um\90_out.csv'
o2=r'C:\Users\11389\Desktop\画图\磁场频率\30um\9093_out.csv'
o3=r'C:\Users\11389\Desktop\画图\磁场频率\30um\93_out.csv'
o4=r'C:\Users\11389\Desktop\画图\磁场频率\30um\30um.png'
...
for i in np.linspace(6.1,9.5,35):
    i=round(i, 1)#取小数点后一位
    indexe=H_9093.tolist().index(i)
...
uhedge=np.append(uhedge,9.5)
ufedge=np.append(ufedge,150)
ulinex=np.append(ufedge,150)
uliney=np.append(uhedge,9.5)
...
plt.title('Cu 30um Thick B-f Curve')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格
plt.scatter(uapp_ff1,uapp_hh1,c='g',s=80,alpha=0.7,marker='D',linewidths=1,edgecolors='black')
plt.scatter(uapp_ff2+dapp_ff2,uapp_hh2+dapp_hh2,c='b',s=80,alpha=0.7,marker='D',linewidths=1,edgecolors='black')
#plt.scatter(dapp_ff2,dapp_hh2,c='b',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
plt.scatter(dapp_ff3,dapp_hh3,c='r',s=80,alpha=0.7,marker='D',linewidths=1,edgecolors='black')
...
ax.annotate('90K',xy=(180, 7.3), xycoords='data',fontsize=24,xytext=(160,6.5),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('93K',xy=(190, 7.5), xycoords='data',fontsize=24,xytext=(200,8),
            arrowprops=dict(facecolor='black', shrink=0.05))
