...
#写入输出地址
w=r'C:\Users\11389\Desktop\画图\磁场频率\30um\t-7t.195hz.csv'
o1=r'C:\Users\11389\Desktop\画图\磁场频率\30um\t-7t.195hz.png'
...
plt.title('7T Vary F Time-K')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格

plt.plot(T4.tolist(),Te4.tolist(),c='gray',linestyle='-',linewidth=2,label='210Hz')
plt.plot(T3.tolist(),Te3.tolist(),c='b',linestyle='-',linewidth=2,label='200Hz')
plt.plot(T2.tolist(),Te2.tolist(),c='g',linestyle='-',linewidth=2,label='190Hz')
plt.plot(T1.tolist(),Te1.tolist(),c='r',linestyle='-',linewidth=2,label='180Hz')

plt.legend(loc='upper left',prop=font1,frameon=True,edgecolor='black')#图注
