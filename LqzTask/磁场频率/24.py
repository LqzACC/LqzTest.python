...
#写入输出地址
w=r'C:\Users\11389\Desktop\画图\磁场频率\24um\24um.csv'
o1=r'C:\Users\11389\Desktop\画图\磁场频率\24um\90_out.csv'
o2=r'C:\Users\11389\Desktop\画图\磁场频率\24um\9093_out.csv'
o3=r'C:\Users\11389\Desktop\画图\磁场频率\24um\93_out.csv'
o4=r'C:\Users\11389\Desktop\画图\磁场频率\24um\24um.png'
...
for i in np.linspace(6.1,10,40):
    i=round(i, 1)#取小数点后一位
    indexe=H_9093.tolist().index(i)
...
uhedge=np.append(uhedge,10)
ufedge=np.append(ufedge,155)
ulinex=np.append(ufedge,155)
uliney=np.append(uhedge,10)
...
plt.title('Cu 24um Thick B-f Curve')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格
plt.scatter(uapp_ff1,uapp_hh1,c='g',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
plt.scatter(uapp_ff2+dapp_ff2,uapp_hh2+dapp_hh2,c='b',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
plt.scatter(dapp_ff3,dapp_hh3,c='r',s=80,alpha=0.7,marker='h',linewidths=1,edgecolors='black')
...
ax.annotate('90K',xy=(185, 7.8), xycoords='data',fontsize=24,xytext=(165,7),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('93K',xy=(195, 8.0), xycoords='data',fontsize=24,xytext=(205,8.5),
            arrowprops=dict(facecolor='black', shrink=0.05))
