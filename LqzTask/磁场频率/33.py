...
#写入输出地址
w=r'C:\Users\11389\Desktop\画图\磁场频率\33um\33um.csv'
o1=r'C:\Users\11389\Desktop\画图\磁场频率\33um\90_out.csv'
o2=r'C:\Users\11389\Desktop\画图\磁场频率\33um\9093_out.csv'
o3=r'C:\Users\11389\Desktop\画图\磁场频率\33um\93_out.csv'
o4=r'C:\Users\11389\Desktop\画图\磁场频率\33um\33um.png'
...
plt.title('Cu 33um Thick B-f Curve')#标题
plt.style.use('ggplot')#背景色
plt.grid(linestyle='--',c='gray',zorder=10)#网格
plt.scatter(uapp_ff1,uapp_hh1,c='g',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
plt.scatter(uapp_ff2+dapp_ff2,uapp_hh2+dapp_hh2,c='b',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
plt.scatter(dapp_ff3,dapp_hh3,c='r',s=80,alpha=0.7,marker='o',linewidths=1,edgecolors='black')
...
ax.annotate('90K',xy=(175, 7.1), xycoords='data',fontsize=24,xytext=(155,6.3),
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate('93K',xy=(190, 7.3), xycoords='data',fontsize=24,xytext=(200,7.8),
            arrowprops=dict(facecolor='black', shrink=0.05))
